...
public class FunctionalTestFixture : IAsyncLifetime
{
    ...
    private YalsWebApplicationFactory? application;
    ...
    public HttpClient CreateClient()
    {
        ...
        {
            throw new Exception("Failed to create YalsWebApplicationFactory");
        }
    ...
    public async Task InitializeAsync()
    {
        ...
        application = new YalsWebApplicationFactory(postgres.GetMappedPublicPort());
    }
...
public class YalsFunctionalTests(FunctionalTestFixture fixture) : IClassFixture<FunctionalTestFixture>
{
    [Fact]
